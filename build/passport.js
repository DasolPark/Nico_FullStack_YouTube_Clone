...
_passport.default.use(new _passportGithub.default({
  ...
  callbackURL: process.env.PRODUCTION ? "https://safe-cliffs-48550.herokuapp.com/".concat(_routes.default.githubCallback) : "http://localhost:4000".concat(_routes.default.githubCallback)
}, _userController.githubLoginCallback));

_passport.default.use(new _passportFacebook.default({
  clientID: process.env.FB_ID,
  clientSecret: process.env.FB_SECRET,
  callbackURL: "https://tame-frog-30.localtunnel.me".concat(_routes.default.facebookCallback),
